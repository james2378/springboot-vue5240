	...
	<div class="detail-preview" :style='{"width":"1200px","margin":"10px auto","position":"relative"}'>
		<div class="attr" :style='{"padding":"20px","position":"relative","flexWrap":"wrap","background":"#f5f5f5","display":"flex"}'>
			...
			<div class="info" :style='{"padding":"10px","boxShadow":" 0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0 10px 0 10px","borderRadius":"20px","alignItems":"center","flexDirection":"column","flex":"1","background":"#ffff","display":"flex","width":"800px"}'>
				...
				<div class="item" :style='{"width":"80%","padding":"10px","margin":"0 0 10px 0","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>车站</div>
					<div  :style='{"padding":"0 10px","color":"#666","background":"#e8f9ff","width":"100%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.chezhan}}</div>
				</div>
				<div class="item" :style='{"width":"80%","padding":"10px","margin":"0 0 10px 0","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"width":"80%","padding":"10px","margin":"0 0 10px 0","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>途径站点</div>
					<div  :style='{"padding":"0 10px","color":"#666","background":"#e8f9ff","width":"100%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.tujingzhandian}}</div>
				</div>
				<div class="item" :style='{"width":"80%","padding":"10px","margin":"0 0 10px 0","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"width":"80%","padding":"10px","margin":"0 0 10px 0","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>剩余车票</div>
